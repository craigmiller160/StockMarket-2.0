...
/**
 * Performs the post-processing initialization for the model
 ...
 */
@ThreadSafe
public class ModelPostProcessor implements BeanPostProcessor, ApplicationContextAware {
	...
	public Object postProcessAfterInitialization(Object bean, String beanName) throws BeansException {
		...
		if(controller == null){
			...
			if(bean instanceof AbstractPropertyModel){
				controller.addPropertyModel((AbstractPropertyModel) bean);
			}
		}
