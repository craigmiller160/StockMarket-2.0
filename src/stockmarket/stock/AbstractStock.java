...
public abstract class AbstractStock implements Stock, Comparable<AbstractStock>, Serializable{
	 ...
	 * @see stockmarket.stock.AbstractStock#getValueMap(boolean) AbstractStock.getValueMap()
	 */
	 ...
	 * 
	 * @see stockmarket.stock.AbstractStock#getModifiableValueMap(boolean) AbstractStock.getModifiableValueMap()
	 */
	@Override
